...
class Bola {
    ...
    // Métodos
    minhaPos = () => {
        // Peguei o index com o indexOf
        return this.arrayBolas.indexOf(this)
    }
    remover = () => {
        // Apagamos o intervalo
    ...
    desenhar = () => {
        ...
        div.setAttribute('style', `left: ${this.px}px; top: ${this.py}px; width: ${this.tam}; height: ${this.tam}px; background-color: rgb(${this.r}, ${this.g}, ${this.b}) `)
